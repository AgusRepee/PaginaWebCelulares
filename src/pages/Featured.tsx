  ...
  return (
    <div className="bg-background-light">
      <PageHeader
        eyebrow="Selección"
        title="Destacados"
        description="Lo mejor de Apple: iPhone, Mac, iPad y AirPods más vendidos y ofertas limitadas."
      />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center bg-white border border-gray-100 rounded-2xl p-8 sm:p-12 shadow-sm">
            <div>
              ...
              <p className="mt-3 text-gray-500 max-w-prose">
                Chip A18 Pro, cámara Pro con zoom 5x y diseño en titanio. El iPhone más avanzado.
              </p>
              ...
              <div className="mt-8 grid grid-cols-3 gap-4">
                {[{ k: '256 GB', v: 'Almacenamiento' }, { k: '5G', v: 'Conectividad' }, { k: 'Cámara Pro', v: 'Sistema' }].map(
                  (x) => (
