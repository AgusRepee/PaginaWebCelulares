            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="lg:col-span-1">
                        <a href="#" className="text-2xl font-bold tracking-tighter text-mobix-black mb-6 inline-block">
                            MOBIX
                        </a>
                    ...
                    {/* Links Column 2 */}
                    <div>
                        <h4 className="font-semibold text-gray-900 mb-4">Servicio</h4>
                        <ul className="space-y-3 text-sm text-gray-500">
                            ...
                            <li><a href="#" className="hover:text-primary transition-colors">Devoluciones y garantía</a></li>
                            <li><a href="#" className="hover:text-primary transition-colors">Contactar soporte</a></li>
                    ...
                    {/* Newsletter */}
                    <div>
                        <h4 className="font-semibold text-gray-900 mb-4">Mantente al día</h4>
                        <p className="text-sm text-gray-500 mb-4">Suscríbete para recibir novedades, ofertas exclusivas y más.</p>
                        <form className="flex flex-col gap-2" onSubmit={(e) => e.preventDefault()}>
                            <input 
                                type="email" 
                                className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-md focus:outline-none focus:border-primary text-sm text-gray-900 placeholder-gray-400" 
                                placeholder="Tu correo electrónico" 
                            />
                            <button className="w-full bg-mobix-black text-white py-2 px-4 rounded-md text-sm font-medium hover:bg-gray-800 transition-colors">
                                Suscribirse
                            </button>
                        </form>
                    </div>
                ...
                <div className="border-t border-gray-100 pt-8 flex flex-col md:flex-row justify-between items-center">
                    <p className="text-xs text-gray-400 mb-4 md:mb-0">
                        © 2024 MOBIX Inc. Todos los derechos reservados.
                    </p>
